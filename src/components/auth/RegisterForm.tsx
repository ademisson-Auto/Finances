  ...
  const handleRegister = async () => {
    ...
    try {
      ...
      if (error) {
        ...
        // Se estivermos usando um sistema que não requer confirmação de email,
        // podemos tentar fazer login automático
        if (data?.user) {
        ...
        // Se o login automático não for possível ou falhar, apenas mostrar alerta
        Alert.alert(
          'Cadastro realizado!', 
